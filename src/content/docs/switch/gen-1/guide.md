---
title: Nintendo Switch 1 选购指南
description: Nintendo Switch 1 值得买吗？适合谁？了解四型号区别、优缺点、价格和购买建议，帮你判断是否值得入手。
sidebar:
  order: 1
---
...
**预算有限、主要玩既有 Switch 游戏 → 选初代；追求性能和新作 → 上 Switch 2。** 
本文梳理初代四个型号的区别，帮你快速判断哪个值得买。
